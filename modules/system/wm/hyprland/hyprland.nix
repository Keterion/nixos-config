  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
        general = {
          ...
          gaps_out = 20;
          border_size = 2;
	  "col.active_border" = "rgb(${osConfig.vars.theming.colors.magenta})";
	  "col.inactive_border" = "rgb(${osConfig.vars.theming.colors.blue1})";
          env = [
	...
	bind = [
	  "$launchMod, R, exec, exec $(tofi-run)"
	  "$launchMod, E, exec, dolphin"
	  "$launchMod, Return, exec, kitty"
	  ...
	  "$systemMod, L, exec, swaylock"
	  "$systemMod, S, exec, swaylock & systemctl suspend"
